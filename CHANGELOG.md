...
### Changed — панель коммита: действия сеткой с подписями
- Полоска безымянных иконок заменена на сетку «иконка + подпись» по 3 в ряд (Stage All, Stash, Fetch, Pull ↓N, Push ↑N — счётчики бейджами). Каждое действие теперь понятно без догадок. Тумблер «Детали» (описание/amend) — снизу, low-emphasis.
