...
> **Дата анализа:** 2026-02-16 | **Последнее обновление:** 2026-02-21
> **Ветка:** master
...
- [ ] Индикатор прогресса для push/pull
...
```
Файлов Kotlin:               ~44 (было ~30; +IGitRepository, +GitResult, +GitRepository*6, +ViewModels*4, +GitRepositoryStash)
Общий объём кода:            ~11,000 строк
...
IGitRepository:              47 методов (добавлены amend + stash x5)
